...
public class WeatherForecastTest {
	...
	@Test
	public void givenStringWithDaysDataShouldReturnDaySelectedWeather() throws IOException {
		/*------------------- Given --------------------- */
		WeatherForecast weatherForecast = new WeatherForecast();
		 ...
		 /*------------------- When --------------------- */
			...
			String result  = weatherForecast.getDaySelectedWeather(daysWeatherData,date);
